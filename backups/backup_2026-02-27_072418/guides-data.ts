...
export const guides: StyleGuide[] = [
  {
    ...
    tag: 'Viral',
    emoji: '🐚',
    image: '/images/guides/trench-coat-outfits-styling-guide-2026.png',
    affiliateProducts: [],
  },

  {
    ...
    affiliateProducts: [
      { name: 'Slim-cut tailored trousers in wool crepe', brand: 'Amazon', price: 'See Price', url: 'https://www.amazon.com/s?k=Slim-cut+tailored+trousers+in+wool+crepe&tag=styleme-20', tag: 'Editor Pick', image: '/images/products/slim-cut-tailored-trousers-in-wool-crepe.svg' },
      ...
      { name: 'Oversized single-breasted blazer', brand: 'Amazon', price: 'See Price', url: 'https://www.amazon.com/s?k=Oversized+single-breasted+blazer&tag=styleme-20', image: '/images/products/oversized-single-breasted-blazer.svg' },
...

  {
    ...
    affiliateProducts: [
      { name: 'Satin Bow Hair Clips Set', brand: 'Amazon', price: '$12', url: 'https://amzn.to/4rVjOFg', tag: 'Editor Pick', image: '/images/products/satin-bow-hair-clips-set.svg' },
  ...
  },
  {
    ...
    image: '/images/guides/winter-to-spring-transition-outfits-2026.png',
    affiliateProducts: [
      { name: 'Satin Pleated Skirt', brand: 'Amazon', price: '$26', url: 'https://amzn.to/3OrVpsf', tag: 'TikTok Viral', image: '/images/products/satin-pleated-skirt.svg' },
  ...
  },
  {
    ...
    affiliateProducts: [
      ...
      { name: 'Satin Slip Dress', brand: 'Amazon', price: '$29', url: 'https://amzn.to/4tH7kT9', tag: 'TikTok Viral', image: '/images/products/satin-slip-dress.svg' },
  ...
  },
  {
    ...
    affiliateProducts: [
      ...
      { name: 'Mesh Ballet Skirt', brand: 'Amazon', price: '$28', url: 'https://amzn.to/3OrVpsf', tag: 'TikTok Fave', image: '/images/products/mesh-ballet-skirt.webp' },
    ],
  },
  {
  ...
  },
  {
    ...
    affiliateProducts: [
      ...
      { name: 'Levi\'s Faux Leather Moto Jacket', brand: 'Amazon', price: '$89', url: 'https://amzn.to/3OhrhzW', tag: 'Budget Pick', image: '/images/products/levi.webp' },
  ...
  // ===== DATE NIGHT GUIDES =====
  {
    ...
    tag: 'Hot',
    emoji: '❤️',
    image: '/images/guides/valentines-day-outfit-ideas-2026.png',
    affiliateProducts: [
  ...
  },
  {
    ...
    tag: 'Trending',
    emoji: '🌙',
    image: '/images/guides/summer-date-night-outfits-2026.png',
    affiliateProducts: [
      ...
      { name: 'Layered Gold Necklace Set', brand: 'Amazon', price: '$16', url: 'https://amzn.to/3Mro3JB', tag: 'Summer Essential', image: '/images/products/layered-gold-necklace-set.webp' },
  ...
  },
  {
    ...
    tag: 'Popular',
    emoji: '🍕',
    image: '/images/guides/casual-date-night-outfits-2026.png',
    affiliateProducts: [
  ...
  },
  {
    ...
    tag: 'New',
    emoji: '✨',
    image: '/images/guides/anniversary-dinner-outfit-ideas-2026.png',
    affiliateProducts: [
