...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  return {
    ...
    keywords: [post.cat.toLowerCase(), 'fashion', 'style tips', 'stylemedaily', post.title.toLowerCase().split(' ').slice(0, 3).join(' ')],
    openGraph: {
      title: post.title,
      description: post.excerpt,
      type: 'article',
    ...
    twitter: { card: 'summary_large_image', site: '@stylemedaily', title: post.title, description: post.excerpt, images: [post.image] },
