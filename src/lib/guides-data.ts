...
export const guides: StyleGuide[] = [
...

  {
    ...
    affiliateProducts: [
      ...
      { name: 'Bias-cut silk slip dress', brand: 'Amazon', price: 'See Price', url: 'https://www.amazon.com/s?k=Bias-cut+silk+slip+dress&tag=styleme-20', image: '/images/products/bias-cut-silk-slip-dress.svg' },
      ...
      { name: 'Cashmere crewneck sweater', brand: 'Amazon', price: 'See Price', url: 'https://www.amazon.com/s?k=Cashmere+crewneck+sweater&tag=styleme-20', image: '/images/products/cashmere-crewneck-sweater.svg' },
      { name: 'Elongated column skirt', brand: 'Amazon', price: 'See Price', url: 'https://www.amazon.com/s?k=Elongated+column+skirt&tag=styleme-20', image: '/images/products/elongated-column-skirt.svg' },
    ],
  },

  {
    ...
    affiliateProducts: [
      ...
      { name: 'Lace Trim Camisole Top', brand: 'Amazon', price: '$22', url: 'https://amzn.to/3ZCaw4S', image: '/images/products/lace-trim-camisole-top.svg' },
      { name: 'Ballet Flats with Bow', brand: 'Amazon', price: '$35', url: 'https://amzn.to/3Mro3JB', image: '/images/products/ballet-flats-with-bow.svg' },
